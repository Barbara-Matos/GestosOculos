...
public class MaquinaOTAsLayoutFragment extends BaseFragment{
    ...
    /**
     * Returns new instance of {@link MaquinaOTAsLayoutFragment}.
     *
     ...
     */
    public static MaquinaOTAsLayoutFragment newInstance(@Nullable String text, @Nullable String footer, @Nullable String timestamp,
                                                 @Nullable Integer menu) {
        final MaquinaOTAsLayoutFragment myFragment = new MaquinaOTAsLayoutFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.maquina_xxx, container, false);
