...
public class InfoMaquinaLayoutFragment extends BaseFragment{
    ...
    /**
     * Returns new instance of {@link InfoMaquinaLayoutFragment}.
     *
     ...
     */
    public static InfoMaquinaLayoutFragment newInstance(@Nullable String text, @Nullable String footer, @Nullable String timestamp,
                                                        @Nullable Integer menu) {
        final InfoMaquinaLayoutFragment myFragment = new InfoMaquinaLayoutFragment();
