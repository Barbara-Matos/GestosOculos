...
public class ListOTAsLayoutFragment extends BaseFragment{
    ...
    /**
     * Returns new instance of {@link ListOTAsLayoutFragment}.
     *
     ...
     */
    public static ListOTAsLayoutFragment newInstance(@Nullable String text, @Nullable String footer, @Nullable String timestamp,
                                                               @Nullable Integer menu) {
        final ListOTAsLayoutFragment myFragment = new ListOTAsLayoutFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.otas, container, false);
