...
public class VideosLayoutFragment extends BaseFragment{
    ...
    /**
     * Returns new instance of {@link VideosLayoutFragment}.
     *
     ...
     */
    public static VideosLayoutFragment newInstance(@Nullable String text, @Nullable String footer, @Nullable String timestamp,
                                                        @Nullable Integer menu) {
        final VideosLayoutFragment myFragment = new VideosLayoutFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.ficheiros2, container, false);
