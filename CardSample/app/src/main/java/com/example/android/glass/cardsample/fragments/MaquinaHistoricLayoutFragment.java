...
public class MaquinaHistoricLayoutFragment extends BaseFragment{
    ...
    /**
     * Returns new instance of {@link MaquinaHistoricLayoutFragment}.
     *
     ...
     */
    public static MaquinaHistoricLayoutFragment newInstance(@Nullable String text, @Nullable String footer, @Nullable String timestamp,
                                                 @Nullable Integer menu) {
        final MaquinaHistoricLayoutFragment myFragment = new MaquinaHistoricLayoutFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.maquina_xxx2, container, false);
